$(function () {
    var pBtn = document.querySelectorAll('.phone-icon');
    pBtn[0].addEventListener('click', myFunk);
    function myFunk() {
        $('.phone-link--phone').toggleClass('active-phone');
    }
    ...
    $('.main-nav--item').click(function () {
        $('.main-nav').removeClass('activ-nav');
    })
...
function btnTopShow() {
    ...
    if ($window.scrollTop() > 500) {
        $btnTop.addClass('is-shown');
    } else {
        $btnTop.removeClass('is-shown');
    }
}
...
function navResize() {
    ...
    if ($window.scrollTop() > 0) {
        $('.header-container').addClass('small-header');
    } else {
        $('.header-container').removeClass('small-header');
    }
}
navResize();
...
$(document).ready(function () {
    $('#orderForm').bind('submit', function (event) {
...
!function (factory) {
    ...
    (function () {
        ...
        jQuery(function ($) {
            ...
            $("#phone2").mask(" +99 (999) 999-99-99");
            $("#phone3").mask(" +99 (999) 999-99-99");
            $("#phone4").mask(" +99 (999) 999-99-99");
            $("#phone5").mask(" +99 (999) 999-99-99");
            $("#phone6").mask(" +99 (999) 999-99-99");
        });
    ...
    $btnTop.on('click', function () {
        $page.on('croll mousedown wheel DOMMouseScroll mousewheel keyup touchmove', function () {
            $page.stop();
        });
